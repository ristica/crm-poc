...
namespace Crm.Dependencies
{
    public class DependencyContainer : IDependencyContainer
    {
        private IUnityContainer _container;
        private static readonly Dictionary<Type, List<string>> RegisteredIdentifiers = new Dictionary<Type, List<string>>();
        ...
        public DependencyContainer(IUnityContainer container = null)
        {
            if (container == null)
            {
                ...
                this.RegisterType<IDependencyContainer, DependencyContainer>();
            }
            else
            {
